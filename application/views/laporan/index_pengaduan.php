                ...
                <div class="col-sm-6 hidden-xs">
                    <div class="header-section">
                        <ul class="breadcrumb breadcrumb-top">
                            ...
                            <li><a href="<?php echo site_url('laporan/pengaduan') ?>">Laporan Pengaduan</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="block">
                    ...
                    <form action="<?php echo site_url('laporan/laporanpengaduan') ?>" method="post" class="form-horizontal form-bordered" target="__blank">
                        <div class="row">
                            <div class="col-md-4">
