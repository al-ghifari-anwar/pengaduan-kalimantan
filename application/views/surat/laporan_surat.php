            ...
            <tbody>
                ...
                foreach ($surat as $data) { ?>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center;"><?= date('d-m-Y', strtotime($data['tanggal_surat'])); ?></td>

                        <td><?= $data['nomor_surat']; ?></td>

                        <td style="text-align:center;"><?= $data['jenis_surat']; ?></td>

                        <td style="text-align:center;"><?= $data['tujuan']; ?></td>

                        <td style="text-align:center;"><?= $data['objek']; ?></td>
