                        ...
                        <?php $no=1; foreach ($kategori as $row) { ?>
                            <tr class="text-center">
                                ...
                                <td class="text-center" width="200px">
                                    <a href="#modal-edit<?= $row['id_kategori'];?>" class="btn btn-effect-ripple btn-success btn-sm" data-toggle="modal"><i class="fa fa-pencil"></i></a>
                                    <a href="<?php echo site_url('master/actionhapuskategori/'.$row['id_kategori']);?>" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus <?php echo $row['nama_kategori'] ?>');" data-toggle="tooltip" title="Hapus <?php echo $row['nama_kategori'] ?>" class="btn btn-effect-ripple btn-danger btn-sm"> <i class="fa fa-times"></i></a>
                                </td> 
                            </tr>
                            <div id="modal-edit<?= $row['id_kategori'];?>" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                            <h3 class="modal-title"><strong><i class="fa fa-plus"></i> Edit Kategori</strong></h3>
                                        </div>
                                        <div class="modal-body">
                                            <form id="form-validation" action="<?= base_url('master/actionkategori');?>" method="POST">
...
<div id="modal-add" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h3 class="modal-title"><strong><i class="fa fa-plus"></i> Tambah Kategori</strong></h3>
            </div>
            <div class="modal-body">
                <form id="form-validation" action="<?= base_url('master/actionkategori');?>" method="POST">
                    <div class="form-group row">
