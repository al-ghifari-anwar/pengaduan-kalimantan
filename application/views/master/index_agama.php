                        ...
                        foreach ($agama as $row) { ?>
                            <tr class="text-center">
                                ...
                                <td class="text-center" width="200px">
                                    <a href="#modal-edit<?= $row['id_agama']; ?>" class="btn btn-effect-ripple btn-success btn-sm" data-toggle="modal"><i class="fa fa-pencil"></i></a>
                                    <a href="<?php echo site_url('master/actionhapusagama/' . $row['id_agama']); ?>" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus <?php echo $row['nama_agama'] ?>');" data-toggle="tooltip" title="Hapus <?php echo $row['nama_agama'] ?>" class="btn btn-effect-ripple btn-danger btn-sm"> <i class="fa fa-times"></i></a>
                                </td>
                            </tr>
                            <div id="modal-edit<?= $row['id_agama']; ?>" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                            <h3 class="modal-title"><strong><i class="fa fa-plus"></i> Edit Agama</strong></h3>
                                        </div>
                                        <div class="modal-body">
                                            <form id="form-validation" action="<?= base_url('master/actionagama'); ?>" method="POST">
                                                <div class="form-group row">
                                                    <label class="col-md-3">Nama Agama</label>
                                                    <input type="hidden" name="statusdata" class="form-control" value="Edit Data">
                                                    <input type="hidden" name="id_agama" class="form-control" value="<?= $row['id_agama']; ?>">
                                                    <div class="col-md-9">
                                                        <input type="text" name="nama_agama" class="form-control" value="<?= $row['nama_agama']; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-md-3">Status</label>
                                                    <div class="col-md-9">
                                                        <select name="status" id="example-chosen" class="select-select2" style="width: 100%;">
            ...
            <div class="modal-body">
                <form id="form-validation" action="<?= base_url('master/actionagama'); ?>" method="POST">
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="nama_agama" class="form-control" autocomplete="off">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-3">Status</label>
